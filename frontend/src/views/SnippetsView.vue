<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
    <!-- 页面头部 -->
    <div class="glass border-b sticky top-0 z-40">
          ...
          <div class="p-6">
            ...
            <div class="relative mb-6">
              ...
              <input v-model="searchQuery" type="text" placeholder="搜索代码片段、标签或描述..."
                class="input pl-12 py-3 rounded-xl bg-white/80 backdrop-blur-sm"
            ...
            <div class="flex flex-wrap items-center gap-4">
              ...
              <div class="relative">
                <select v-model="selectedLanguage" @change="handleLanguageChange"
                  class="input appearance-none bg-white/80 backdrop-blur-sm px-4 py-2 pr-10 text-sm">
